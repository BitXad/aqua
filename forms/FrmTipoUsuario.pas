...
var
  FormTipoUsuario: TFormTipoUsuario;
...
procedure TFormTipoUsuario.Iniciar();
begin
...
procedure TFormTipoUsuario.DBNavigator1Click(Sender: TObject;
  Button: TNavigateBtn);
begin
...
procedure TFormTipoUsuario.sBitBtn2Click(Sender: TObject);
begin
try
...
procedure TFormTipoUsuario.sBitBtn5Click(Sender: TObject);
begin
        DBNavigator1.BtnClick(nbcancel);
        Close;
end;

procedure TFormTipoUsuario.DBGrid1DrawColumnCell(Sender: TObject;
