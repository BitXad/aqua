...
procedure TFormCiudadExp.Iniciar();
begin
...
procedure TFormCiudadExp.DBNavigator1Click(Sender: TObject;
  Button: TNavigateBtn);
begin
...
procedure TFormCiudadExp.sBitBtn2Click(Sender: TObject);
begin
try
...
procedure TFormCiudadExp.sBitBtn5Click(Sender: TObject);
begin
        DBNavigator1.BtnClick(nbcancel);
        Close;
end;

procedure TFormCiudadExp.DBGrid1DrawColumnCell(Sender: TObject;
