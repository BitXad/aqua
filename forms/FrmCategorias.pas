...
procedure TFormCategorias.Iniciar();
begin
...
procedure TFormCategorias.DBNavigator1Click(Sender: TObject;
  Button: TNavigateBtn);
begin
...
procedure TFormCategorias.sBitBtn2Click(Sender: TObject);
begin
try
...
procedure TFormCategorias.sBitBtn5Click(Sender: TObject);
begin
        DBNavigator1.BtnClick(nbcancel);
        Close;
end;

procedure TFormCategorias.DBGrid1DrawColumnCell(Sender: TObject;
