...
procedure TFormEstados.Iniciar();
begin
...
procedure TFormEstados.DBNavigator1Click(Sender: TObject;
  Button: TNavigateBtn);
begin
...
procedure TFormEstados.sBitBtn2Click(Sender: TObject);
begin
try
...
procedure TFormEstados.sBitBtn5Click(Sender: TObject);
begin
        DBNavigator1.BtnClick(nbcancel);
        Close;
end;

procedure TFormEstados.DBGrid1DrawColumnCell(Sender: TObject;
