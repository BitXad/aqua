...
procedure TFormZonas.DBNavigator1Click(Sender: TObject;
  Button: TNavigateBtn);
begin
...
procedure TFormZonas.sBitBtn2Click(Sender: TObject);
begin
try
...
procedure TFormZonas.sBitBtn5Click(Sender: TObject);
begin
        DBNavigator1.BtnClick(nbcancel);
        Close;
end;

procedure TFormZonas.DBGrid1DrawColumnCell(Sender: TObject;
