object FormRepKardex2: TFormRepKardex2
  Left = 162
  Top = 72
  Width = 941
  Height = 780
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr18: TQRExpr
        ...
        Transparent = True
        WordWrap = True
        Expression = 'ADOReporte.categoria_asoc'
        FontSize = 8
      end
      ...
      object QRExpr19: TQRExpr
        ...
        Transparent = True
        WordWrap = True
        Expression = 'ADOReporte.telefono_asoc'
        FontSize = 8
      end
      ...
      object QRExpr20: TQRExpr
        ...
        Transparent = True
        WordWrap = True
        Expression = 'ADOReporte.fechahora_asoc'
        FontSize = 8
      end
  ...
  object ADOReporte: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM asociado a,lectura l, factura f WHERE a.id_asoc = ' +
        '200 AND a.id_asoc = l.id_asoc AND l.id_lec = f.id_lec')
    Left = 400
    Top = 24
