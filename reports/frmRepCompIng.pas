...
var
  FormRepCompIng: TFormRepCompIng;
...
{$R *.dfm}
procedure TFormRepCompIng.Consulta(Num:String);
Var
        SQL:String;
begin
...
procedure TFormRepCompIng.Iniciar();
begin

    QuickRep1.preview;
End;
Function TFormRepCompIng.NLiteral(X:String):String;
var
        i,ban:integer;
