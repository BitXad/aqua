object FormRepIngresosFact: TFormRepIngresosFact
  Left = 501
  Top = 80
  Width = 939
  Height = 780
  Caption = 'Reporte - Asociados'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr2: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'if(ADOReporte.num_fact=0,'#39'PENDIENTE'#39',ADOReporte.num_fact+'#39'/'#39'+ADO' +
          'Reporte.id_lec)'
        FontSize = 8
      end
      ...
      object QRExpr5: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'ADOReporte.actual_lec+'#39' - '#39'+ADOReporte.anterior_lec+'#39' = '#39'+ ADORe' +
          'porte.consumo_lec'
        FontSize = 8
      end
    ...
    object QRBand2: TQRBand
      ...
      object QRExpr14: TQRExpr
        ...
        Transparent = True
        WordWrap = True
        Expression = 'formatnumeric('#39'#,#0.00'#39',sum(ADOReporte.consumo_lec))'
        FontSize = 8
      end
  ...
  object ADOReporte: TADOQuery
    ...
    object ADOReportefoto_asoc: TStringField
      FieldName = 'foto_asoc'
      Size = 250
    end
    ...
    object ADOReporteorden_asoc: TIntegerField
      FieldName = 'orden_asoc'
    end
    object ADOReporteice_fact: TFloatField
      FieldName = 'ice_fact'
    end
    object ADOReporteid_ing: TIntegerField
      FieldName = 'id_ing'
    end
  end
