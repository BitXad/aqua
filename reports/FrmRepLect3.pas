...
{$R *.dfm}
procedure TFormRepLect3.Imprimir();
begin
    QuickRep1.Print;
end;
procedure TFormRepLect3.VistaPrevia();
begin
    QuickRep1.preview;
end;
                                  
procedure TFormRepLect3.Consulta(idlec:String);
Var
        SQL: String;
begin
    try
