...
{$R *.dfm}
procedure TFormRepfact1.Imprimir();
begin
    QRTipo.Expression:= 'if(ADODetalle.tipo_fact=1,'+quotedStr('ORIGINAL')+','+quotedStr(' ')+')';
    QuickRep1.Print;
end;

procedure TFormRepfact1.ImprimirCopia();
begin
    QRTipo.Expression:= QuotedStr('COPIA');
    QuickRep1.Print;
end;

procedure TFormRepfact1.VistaPrevia();
begin
    QuickRep1.preview;
end;

procedure TFormRepfact1.Consulta(idlec:String);
Var
        SQL: String;
begin
    try
...
procedure TFormRepfact1.Consulta2(iding:String);
Var
        SQL: String;
begin
    try
