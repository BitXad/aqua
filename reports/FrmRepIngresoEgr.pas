...
var
  FormRepEgresos: TFormRepEgresos;
...
procedure TFormRepEgresos.VistaPrevia();
begin
    QuickRep1.Preview;
end;
procedure TFormRepEgresos.Imprimir();
begin
    Quickrep1.Print;
end;

procedure TFormRepEgresos.Consultar(SQL:String);
begin
...
procedure TFormRepEgresos.ConsultaPorAsociado(fecha1,fecha2:Tdate; id_asoc:String);
var
...
procedure TFormRepEgresos.ConsultaPorFecha(fecha1,fecha2:Tdate);
var
    SQL,orden,usuario:String;
begin
...
procedure TFormRepEgresos.ConsultaPorDia(fecha1,fecha2:Tdate);
var
    SQL,orden,usuario:String;
begin
...
procedure TFormRepEgresos.Iniciar(mes,gestion:String);
var
    SQL:String;
begin
    SQL:='select * from ingreso_egreso';
