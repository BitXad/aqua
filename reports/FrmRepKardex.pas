...
procedure TFormRepKardex.VistaPrevia();
begin
    QuickRep1.Preview;
end;
procedure TFormRepKardex.Imprimir();
begin
    Quickrep1.Print;
end;

procedure TFormRepKardex.Consultar(SQL:String);
begin
...
//*************************************************************************//
procedure TFormRepKardex.ConsultaPorAsociado(fecha1,fecha2:Tdate; id_asoc:String);
var
...
procedure TFormRepKardex.ConsultaPorFecha(fecha1,fecha2:Tdate);
var
    SQL,orden,usuario:String;
begin
...
procedure TFormRepKardex.ConsultaPorDia(fecha1,fecha2:Tdate);
var
    SQL,orden,usuario:String;
begin
...
procedure TFormRepKardex.Iniciar(mes,gestion:String);
var
    SQL:String;
begin
