object FormRepDeudasPorCobrar: TFormRepDeudasPorCobrar
  Left = 176
  Top = 80
  Width = 939
  Height = 780
  Caption = 'Reporte - Deudas Por Cobrar'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr2: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'if(ADOReporte.num_fact=0,'#39'PENDIENTE'#39','#39'FACT.: '#39'+ADOReporte.num_fa' +
          'ct)'
        FontSize = 8
      end
  ...
  object ADOReporte: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  a.nombres_asoc,'
      '  a.servicios_asoc,'
      '  concat(l.`mes_lec`,'#39'/'#39',l.`gestion_lec`) as gestion,'
      '  ROUND(l.consumo_lec,2) as mt3,'
      '  ROUND(f.`montoparc_fact`,2) as consumo,'
      
        '  ROUND(f.`totalconsumo_fact` - f.`montoparc_fact`,2) as alcanta' +
        'rillado,'
      '  ROUND(0.6,2) as fecoapaq,'
      '  ROUND(f.`totalaportes_fact` - 0.6,2) as rep_form ,'
      '  ROUND(f.`totalrecargos_fact`,2) as multas,'
      '  ROUND(f.`montototal_fact`,2) total_factura,'
      '  f.`id_fact`'
      '  '
      'FROM'
      '  asociado a,'
      ...
      '  l.mes_lec = '#39'NOVIEMBRE'#39' AND '
      '  l.gestion_lec = '#39'2016'#39' AND '
    ...
    object ADOReportegestion: TStringField
      FieldName = 'gestion'
      ReadOnly = True
      Size = 41
    end
    object ADOReportemt3: TFloatField
      FieldName = 'mt3'
      ReadOnly = True
    end
    object ADOReporteconsumo: TFloatField
      FieldName = 'consumo'
      ReadOnly = True
    end
    object ADOReportealcantarillado: TFloatField
      FieldName = 'alcantarillado'
      ReadOnly = True
    end
    object ADOReportefecoapaq: TBCDField
      FieldName = 'fecoapaq'
      ReadOnly = True
      Precision = 3
      Size = 2
    end
    object ADOReporterep_form: TFloatField
      FieldName = 'rep_form'
      ReadOnly = True
    end
    object ADOReportemultas: TFloatField
      FieldName = 'multas'
      ReadOnly = True
    end
    object ADOReportetotal_factura: TFloatField
