...
type
  TFormRepListaAsociado = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRLabel2: TQRLabel;
    QRLabel5: TQRLabel;
...
var
  FormRepListaAsociado: TFormRepListaAsociado;
...
procedure TFormRepListaAsociado.Consultar(SQL:String);
begin
...
procedure TFormRepListaAsociado.Iniciar(mes,gestion:String);
var
    SQL:String;
begin
